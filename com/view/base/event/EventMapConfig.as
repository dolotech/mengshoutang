...
package com.view.base.event
{
	...
	public class EventMapConfig
	{
		 ...
		 * @private
		 */
		public function EventMapConfig(dispatcher : EventDispatcher, eventString : String, listener : Function, eventClass : Class, callback : Function)
		{
		...
		public function equalTo(dispatcher : EventDispatcher, eventString : String, listener : Function, eventClass : Class) : Boolean
		{
