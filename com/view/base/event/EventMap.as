...
package com.view.base.event
{
	...
	public class EventMap
	{
		 ...
		 * @inheritDoc
		 */
		public function mapListener(dispatcher : EventDispatcher, eventString : String, listener : Function, eventClass : Class = null) : void
		{
			eventClass ||= Event;
			...
			const callback : Function = eventClass == Event ? listener : function(event : Event) : void
				{
		 ...
		 * @inheritDoc
		 */
		public function unmapListener(dispatcher : EventDispatcher, eventString : String, listener : Function, eventClass : Class = null) : void
		{
			eventClass ||= Event;
