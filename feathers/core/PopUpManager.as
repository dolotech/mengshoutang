...
package feathers.core
{
	...
	public class PopUpManager
	{
		...
		{
			return (forStarling(Starling.current) as DefaultPopUpManager)._popUps.length > 0 ? false : true;
		}
		...
		public static function removePopUps():void
		{
			PopUpManager.forStarling(Starling.current).removePopUps();
		}
