...
package feathers.dragDrop
{
	...
	public class DragDropManager
	{
		 ...
		 */
		protected static var dropTarget:IDragSource;
		 ...
		 */
		public static function acceptDrag(target:IDragSource):void
		{
		...
		protected static function updateDropTarget(location:Point):void
		{
			...
			while(target && !(target is IDragSource))
			{
