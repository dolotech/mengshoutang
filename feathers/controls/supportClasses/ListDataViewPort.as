...
package feathers.controls.supportClasses
{
	...
	public class ListDataViewPort extends FeathersControl implements IViewPort
	{
		...
		public function refreshLayoutTypicalItem():void
		{
		...
		private function refreshRenderers():void
		{
			...
			var i:int = 0;
			var l:int = this._inactiveRenderers.length;
			for (i = 0; i < l; i++)
			{
				var itemRender:DisplayObject = this._inactiveRenderers[i] as DisplayObject;
				if (!itemRender)
				{
					//	JTLogger.error();
				}
		...
		private function findUnrenderedData():void
		{
			...
			for(i = 0; i < unrenderedItemCount; i++)
			{
				...
				if(renderer)
				{
					...
					//want to do it again!
					//JTLogger.info("[_typicalItemRenderer]:" + this._typicalItemRenderer,  "       renderer:" + renderer);
		 ...
		 * 
		 */
		public function dataProvider_refreshItemHandler():void
		{
			...
			{
				dataProvider_updateItemHandler(null,i);
			}
		}
