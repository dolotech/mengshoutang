...
package starling.text
{
	...
	public class TextField extends DisplayObjectContainer
	{
		...
		public function TextField(width : int, height : int, text : String, fontName : String = "myFont", fontSize : Number = 12, color : uint = 0x0, bold : Boolean = false)
		{
			mText = text ? text : "";
			mFontSize = fontSize;
			mColor = color;
...
//			this.fontName = fontName == "" ? "myFont" : fontName;
		...
		public function createRenderedContents() : void
		{
			if (mQuadBatch)
			{
