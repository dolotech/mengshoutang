    ...
    public class DisplayObject extends EventDispatcher
    {
        ...
        public function DisplayObject() {
            ...
            if (DeviceType.getType() == DeviceType.DESKTOP) {
                if (!_staticDic[getQualifiedClassName(this)]) {
                    _staticDic[getQualifiedClassName(this)] = 1;
                }
                else {
                    _staticDic[getQualifiedClassName(this)]++;
                }
            }
        }
        ...
        public static var _staticDic:Object = {};
