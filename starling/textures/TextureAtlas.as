...
import flash.utils.Dictionary;
    ...
    public class TextureAtlas
    {
        ...
        public function TextureAtlas(texture:Texture, atlas:Object = null) {
        ...
        if (atlas) {
            if (atlas is XML) {
                parseAtlasXml(atlas as XML);
            }
            else if (atlas is ByteArray) {
                parseAtlasBytes(atlas as ByteArray);
            }
        }
    }
        ...
        public function getTexture(name:String):Texture
        {
           ...
           else return Texture.fromTexture(mAtlasTexture, region, mTextureFrames[name], _XMLScale);
        }
