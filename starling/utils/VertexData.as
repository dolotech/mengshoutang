...
//           var clone:VertexData = new VertexData(0, mPremultipliedAlpha);
            var clone:VertexData = getInstance(0, mPremultipliedAlpha);
        ...
        *  that, use the 'setPremultipliedAlpha' method instead. */
        ...
        private function reset(numVertices:int, premultipliedAlpha:Boolean=false):void
        {
        ...
        public static function recycleInstance(vertexData:VertexData):void
        {
//            if(_pool.length < 1000)
//            {
//                if(_pool.indexOf(vertexData) == -1)
//                {
//                    _pool.push(vertexData);
//                }
//            }
//            trace("recycleInstance",_pool.length);
        }
        public static function getInstance(numVertices:int, premultipliedAlpha:Boolean=false):VertexData
        {
            var vertexData:VertexData;
//            if(_pool.length > 0)
//            {
//                vertexData  =  _pool.pop();
//                vertexData.reset(numVertices,premultipliedAlpha);
//            }
//            else
            {
                vertexData =  new VertexData(numVertices,premultipliedAlpha);
            }
            return vertexData;
        }
    }
