package game.view.rank
{
	...
	import game.view.rank.ui.JTUIHeroPropertys;
	
	import starling.display.Sprite;
	import starling.events.Event;
	import com.utils.Constants;
	
	public class JTHeroPropertyPanel extends JTUIHeroPropertys
	{
		private static var instance:JTHeroPropertyPanel = null;
		...
		public function JTHeroPropertyPanel()
		{
			super();
			initialize();
		}
		...
		public static function show(parent:Sprite, heroInfo:HeroData):void
		{
			if (!instance)
			{
				instance = new JTHeroPropertyPanel();
				instance.x = 451.5;
				instance.y = 80.8;
...
class JTHeroSkillPanel extends JTUIHeroSkill
{
	...
	public function show(heroInfo:HeroData):void
	{
		...
		for (i = 0; i < l; i++)
		{
			...
			if (skill_ID > 0)
			{
				txt_caption.text = skillInfo.name;
				txt_skill.text = skillInfo.desc;
			}
			else
			{
				txt_skill.text = "";
			...
			{
				skill2Txt.text = skillInfo.name;
				caption2Txt.text = skillInfo.desc;
				skill3Txt.text = "";
				caption3Txt.text = "";
			}
		}
