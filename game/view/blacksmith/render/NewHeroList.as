package game.view.blacksmith.render {
     ...
     *
     */
    public class NewHeroList extends View {
        public static var POSTION:Number = 0;
        public var _selectedIndex:int = 0;
        public var list_hero:List;
        public var selectedAnimation:SpriterClip;
        public var isDragEnable:Boolean;

        public function NewHeroList(isDragEnable:Boolean = false) {
            super();
