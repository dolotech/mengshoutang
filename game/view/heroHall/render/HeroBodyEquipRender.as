package game.view.heroHall.render
{
	 ...
	 *
	 */
	public class HeroBodyEquipRender extends NewHeroBodyEquipRenderBase
	{
		public static var selectedAnimation:SpriterClip;

		public function HeroBodyEquipRender()
		{
			super();
//            tag_box.touchable = false;
		}
...
//            bg_level.visible = widget.level > 0;
